...
(async () => {
  ...
  if (!window.ai) {
    ...
    errorMessage.innerHTML = `Your browser doesn't support the Prompt API. If you're on Chrome, join the <a href="https://developer.chrome.com/docs/ai/built-in">Early Preview Program</a> to enable it.`;
    return;
  }
